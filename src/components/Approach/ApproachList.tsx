...
function ApproachList() {
  return (
    <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-black-100 w-full gap-4 mx-auto px-8">
      <Card title="Sheetal is Nisha" icon={<MagicButton>Phase 3</MagicButton>}>
        <CanvasRevealEffect
          animationSpeed={5.1}
          containerClassName="bg-emerald-900"
        />
      </Card>
      <Card title="Nisha is Munni" icon={<MagicButton>Phase 3</MagicButton>}>
        <CanvasRevealEffect
          animationSpeed={3}
      ...
      <Card title="Munni is Aditi" icon={<MagicButton>Phase 3</MagicButton>}>
        <CanvasRevealEffect
          animationSpeed={3}
